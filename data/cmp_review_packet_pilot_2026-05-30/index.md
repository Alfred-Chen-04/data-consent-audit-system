# CMP Manual Review Packet

8 pending review cards. Use these evidence refs to fill the worksheet.

## BBC

- URL: https://www.bbc.com
- Category/cohort/tier: news / smoke / High-Risk
...
![Weekly capture](../captures/sites/www_bbc_com_20260529_184907/layer1.png)
...
![Weekly capture](../captures/sites/www_nytimes_com_20260529_184912/layer1.png)

## Reddit

- URL: https://www.reddit.com
- Category/cohort/tier: social / smoke / High-Risk
- Review reason: no banner observed in access probe or weekly capture; inspect saved screenshots/DOM to verify CMP presence, region behavior, or sample fit
- Recommended action: manual screenshot/DOM review; rerun with fresh browser context if a CMP is expected
- Decision options: `keep_consent_sample|keep_no_banner_case|rerun_fresh_context|replace_candidate|exclude`
...
![Weekly capture](../captures/sites/www_reddit_com_20260529_161027/layer1.png)

## Amazon

- URL: https://www.amazon.com
- Category/cohort/tier: ecommerce / pilot / High-Risk
- Review reason: no banner observed in access probe or weekly capture; inspect saved screenshots/DOM to verify CMP presence, region behavior, or sample fit
- Recommended action: manual screenshot/DOM review; rerun with fresh browser context if a CMP is expected
- Decision options: `keep_consent_sample|keep_no_banner_case|rerun_fresh_context|replace_candidate|exclude`
...
![Weekly capture](../captures/sites/www_amazon_com_20260529_184922/layer1.png)
...
![Weekly capture](../captures/sites/www_walmart_com_20260529_184926/layer1.png)

## Airbnb

- URL: https://www.airbnb.com
- Category/cohort/tier: travel / pilot / High-Risk
- Review reason: no banner observed in access probe or weekly capture; inspect saved screenshots/DOM to verify CMP presence, region behavior, or sample fit
- Recommended action: manual screenshot/DOM review; rerun with fresh browser context if a CMP is expected
- Decision options: `keep_consent_sample|keep_no_banner_case|rerun_fresh_context|replace_candidate|exclude`
...
![Weekly capture](../captures/sites/www_airbnb_com_20260529_184932/layer1.png)

## Spotify

- URL: https://www.spotify.com
- Category/cohort/tier: entertainment / pilot / High-Risk
- Review reason: no banner observed in access probe or weekly capture; inspect saved screenshots/DOM to verify CMP presence, region behavior, or sample fit
- Recommended action: manual screenshot/DOM review; rerun with fresh browser context if a CMP is expected
- Decision options: `keep_consent_sample|keep_no_banner_case|rerun_fresh_context|replace_candidate|exclude`
...
![Weekly capture](../captures/sites/www_spotify_com_20260529_184935/layer1.png)

## Chase

- URL: https://www.chase.com
- Category/cohort/tier: finance / pilot / High-Risk
- Review reason: no banner observed in access probe or weekly capture; inspect saved screenshots/DOM to verify CMP presence, region behavior, or sample fit
- Recommended action: manual screenshot/DOM review; rerun with fresh browser context if a CMP is expected
- Decision options: `keep_consent_sample|keep_no_banner_case|rerun_fresh_context|replace_candidate|exclude`
...
![Weekly capture](../captures/sites/www_chase_com_20260529_184940/layer1.png)
