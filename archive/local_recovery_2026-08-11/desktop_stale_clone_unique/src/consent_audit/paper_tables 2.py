...
def _render_tables(
    *,
    ...
    return (
        ...
        f"- Latest target tiers: {_format_counts(_count_target_values(targets, reports, 'tier', default='missing')) or 'none'}\n"
        ...
        "| Site | Category | Tier | L1 gate | Available paths | Missing paths | L2 effort | Transparency | Unbiased | Evidence refs |\n"
        "|---|---|---|---|---|---|---|---|---|---|\n"
