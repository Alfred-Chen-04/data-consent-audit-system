...
def _render_poster_plan(
    *,
    ...
    return (
        ...
        f"- Latest target tiers: {_format_counts(tier_counts) or 'none'}\n"
        ...
        f"| RQ1 evidence | Results band | Current target tiers: {_format_counts(tier_counts) or 'none'}. |\n"
        ...
        f"- Preliminary RQ1 result: current target tiers are {_format_counts(tier_counts) or 'none'}.\n"
