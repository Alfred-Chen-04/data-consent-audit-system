...
The automated RQ1 table currently labels missing first-layer paths as
`High-Risk`, but after visual review I do not think that label should be used
as a final paper claim for CNN, Booking.com, or NerdWallet. Their screenshots
show no visible first-screen consent banner in this capture, so I am treating
them as no-visible-banner contrast candidates pending the sample-coding rule.
The clearer banner-present cases in this five-site gate are The Guardian and
Coca-Cola.
