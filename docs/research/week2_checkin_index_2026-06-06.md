...
- [Previous advisor email: scope update and next decisions, 2026-07-01](advisor_email_scope_update_2026-07-01.md)
...
- `PYTHONPATH=src .venv/bin/python -m consent_audit.cli closeout-prefreeze-manifest`
